...
//  Siliqua
//
//  Created by CokePokes on 9/9/17.
...
@interface Siliqua : NSObject

@end

@implementation Siliqua
...
CHConstructor // code block that runs immediately upon load
{
	@autoreleasepool
	{
		...
		// this would be posted using: notify_post("com.laughingquoll.Siliqua.eventname");
		CFNotificationCenterRef darwin = CFNotificationCenterGetDarwinNotifyCenter();
		CFNotificationCenterAddObserver(darwin, NULL, ExternallyPostedNotification, CFSTR("com.laughingquoll.Siliqua.eventname"), NULL, CFNotificationSuspensionBehaviorCoalesce);
